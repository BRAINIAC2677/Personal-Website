function MainContent() {
  return (
    <div className="flex flex-col sm:flex-row-reverse justify-center sm:justify-around items-center mx-auto mt-12 lg:mt-20 sm:w-3/4">
      ...
      <div className="pt-4 sm:pt-0 sm:pr-8 text-lg text-center sm:text-left text-ink uppercase tracking-wider z-10">
        <p>hello i'am </p>
        <p className="py-2 font-permanent-marker text-4xl sm:text-5xl tracking-widest">
          asif azad
        </p>
        <p>cse freshmen</p>
        <a
